...
reservadas="(?!(int|short int|long int|bool|float|double|long double|const|if|else|while|switch|case|break|for|do|static|extern|register|auto))"
indent="[^0-9]*"+reservadas+"([a-z]|[A-Z]|_)+"#([a-z]|[A-Z]|_|[0-9])*"#falta evitar que se ingresen palabras reservadas
exp="(=[0-9]+(.[0-9]+)*)?;"
